...
resultFile = fopen(strcat(datestr(now(),'yyyy-mm-dd [HH_MM_SS]'),'dim_200.txt'),'w');

for i=1:500
    [fg, missed] = PCABayes5(trainImages, trainLabels, weight,200);
    ...
    %if mod(i,20)==1
        acc = benchMark(trainImages, trainLabels, models);
